  ...
  <Layout>
    <div className="container mx-auto py-24 px-16">
      <div className="flex items-center">
        ...
        <h1 className="ml-2">Awesome MENA Meetups and Conferences</h1>
      </div>
      <div className="py-4 text-lg">
        Check out awesome
        <Link
          className="hover:font-bold hover:underline no-underline font-semibold text-purple-dark ml-1"
          to="/conferences"
        >
          conferences
        </Link>{' '}
      ...
      <div className="text-grey-darker font-thin">Sign up for updates:</div>
